...
export const ModalContactEdit = ({ onClose, id, name, number }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (name !== form.elements.name.value && form.elements.name.value !== '') {
      objContact.name = form.elements.name.value;
    } else if (number !== form.elements.number.value && form.elements.number.value !== '') {
      objContact.number = form.elements.number.value;
    }
